...
namespace InvoiceApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Data
            User goran = new User("Goran", "Turundzov", 076615042,  "goran", "test123" ,"1234");
            ...
            User bob = new User("Bob", "Bobsky", 077777555, "bob", "test123" , "1234");
           ...
           bob.Invoices.Add(new Invoice("Parno", EnumCompany.BEG, new DateTime(2021, 03, 17), new DateTime(2021, 04, 18), 1513));
            User sara = new User("Sara", "Sarsky", 075434564, "sara", "test123" , "1234");
        ...
        static void UserUI(User user)
        {
            while (true)
            {
                if (user.FailedLogInAttempts > 2) break;
